            ...
            <form>
                <div className='flex justify-center '>
                    <div className='flex-col flex justify-center  px-20 py-4 rounded-lg'>
                        ...
                        card ${theme === "Dark"
                        ? "transition border-solid border-[2px] border-neutral-800  text-neutral-300  hover:bg-neutral-900  hover:text-neutral-200 duration-200"
                        : " transition border-solid border-[2px] border-neutral-500 text-neutral-500  hover:bg-neutral-200  hover:text-neutral-600 duration-200 "
                        }`}>
