          ...
          <div className="flex flex-col md:flex-row flex-1">
            ...
            <div className="flex-1 flex flex-col md:flex-row">
              <div className="bg-neutral-800 h-64 md:h-96 rounded-lg mb-4 flex-1 relative">
                ...
                >
                   {isCarouselOpen ? <FaChevronUp size={20} /> : <FaChevronDown size={20} />}
                </button>
              </div>
          ...
          {isCarouselOpen && (
            <div className="mt-4 bg-zinc-800 p-4 rounded-lg">
              <div className="flex items-center justify-between">
                <button onClick={prevImage} className="text-zinc-300 text-2xl p-2"><FaChevronLeft /></button>
                ...
                <button onClick={nextImage} className="text-zinc-300 text-2xl p-2"><FaChevronRight /></button>
              </div>
            </div>
          )}
        </div>
